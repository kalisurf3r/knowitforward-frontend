...
export default function Profile(props) {
  ...
  async function getSvcsOffrdAndPruneThem() {
    ...
    console.log(
      "Services that were offered by this user are: ",
      svcsOffrd.data
    );
          ...
          <div className="col col-md-4 col-sm-6 col-12 userDetailsSection">
            <div className="userPicAndPersonalDetails">
              ...
              <div className="userPersonalDetails">
                ...
                <p className="userDet">
                  <FontAwesomeIcon icon={faStar} /> {userDetails.ratings}
                </p>
            ...
            <ul className="list-group list-group-flush">
              <li
                ...
                id="svcsOffered"
                onClick={(e) => handleSvcOffrdClick(e)}
              >
                <h4>Services I Offered</h4>
              </li>
              <li
                className="list-group-item"
                id="svcsBooked"
                onClick={(e) => handleSvcBookedClick(e)}
              >
                <h4>Services I've Booked</h4>
              </li>
            </ul>
          </div>
